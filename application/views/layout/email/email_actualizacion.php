            ...
            <tr>
                <td>
                    <div class="x_sgwrap x_title_blue">
                        <h2>Sistema de asistencias uniclaretiana</h2>
                    </div>
                </td>
            </tr>
            <tr>
                <td>
                    ...
                    <p>Hemos actualizado tus datos para el sistema de asistencia estudiantil "Uniclaretiana".</p>
                    <p>Ahora puedes continuar y realizar tu asistencia en la plataforma.</p>
