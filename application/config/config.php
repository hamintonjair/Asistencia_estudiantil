...
|
*/
$config['base_url'] = 'http://localhost/Asistencia_estudiantil/';
...
$config['sess_expire_on_close'] = FALSE; // Si es TRUE, la cookie expirará cuando el navegador se cierre
$config['sess_encrypt_cookie'] = FALSE; // Si es TRUE, cifrará el valor de la cookie

$config['sess_use_database'] = FALSE; // Si es TRUE, almacena la información de sesión en la base de datos
$configig['sess_samesite'] = 'Lax';
$config['sess_expiration'] = 7200;
$config['sess_match_useragent'] = TRUE; // Si es TRUE, verifica el agente de usuario al validar la cookie de sesión
